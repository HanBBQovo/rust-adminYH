...
INSERT INTO `memory` (`id`, `name`, `createAt`, `updateAt`) VALUES
  ...
  (3, '迁移收货人', '2026-01-01 08:07:30', '2026-01-01 08:07:30');
...
INSERT INTO `avatar` (`id`, `filename`, `mimetype`, `size`, `user_id`, `createAt`, `updateAt`) VALUES
  ...
  (3, 'orphan-avatar-smoke.jpg', 'image/jpeg', 19, 999, '2026-01-01 08:09:30', '2026-01-01 08:09:30');
...
INSERT INTO `role_permission` (`id`, `role_id`, `permission_id`, `createAt`, `updateAt`) VALUES
  ...
  (10, 2, 12, '2026-01-01 08:13:02', '2026-01-01 08:13:02');
...
INSERT INTO `company_order` (`id`, `com_name`, `order_id`, `createAt`, `updateAt`) VALUES
  ...
  (3, '迁移发货公司', 999, '2026-01-03 09:01:00', '2026-01-03 09:01:00');
...
INSERT INTO `receipt` (
  ...
  (
    2, 'MIG-SMOKE-ORPHAN-RECEIPT', 1783180800000, '异常回收', '已发放', '已退回',
    1, '迁移异常发货人', '迁移异常收货人', '迁移异常货物', '1',
    '2026-01-03 09:02:00', '2026-01-03 09:02:00'
  );
