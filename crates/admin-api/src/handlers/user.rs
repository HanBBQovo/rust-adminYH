use admin_core::{
    dto::{
        AvatarInfo, AvatarUploadInput, CurrentUserResponse, UserCreateRequest, UserDetailResponse,
        UserListRequest, UserListResponse, UserPasswordRequest, UserUpdateRequest,
    },
    AppError,
};
use axum::{
