...
use admin_core::services::{
    ...
    development_role_service, development_user_service, InMemoryAuthUserStore, StaticHealthService,
};
use axum::body::Body;
...
async fn users_me_returns_current_user_for_login_token() {
    ...
    assert_eq!(json["data"]["roles"][0], "1");
    assert_eq!(json["data"]["roleIds"][0], 1);
}
